    ...
    render() {
        return (
            ...
            <div>
                ...
                <div className='title'>UX Case Study</div>
                <div className='things'><img width="850px" alt='banner' src={uxbanner} ></img></div>


                <div className="sub-heading">Challenge</div>

                <Col className='things' style={{width: "900px", fontSize: "18px"}}>
                    <Row>
                        <Col style={{marginTop: "auto", marginBottom: "auto"}}><img alt='zara' src={zara} width="450px"></img></Col>
                        <Col style={{ width: "450px", padding: "30px" }}>Bad Interface
                            For my research, I analyzed popular e-commerce portals like Amazon, Zara, Myntra, Nyka, Sephora, Flipkart, H&M, etc. In the Product List pages, there are too many or too few products in a row. In cases with 2 or 3 products in a row, the page has wide left and right margins. This is wasted real estate. In cases with 4+ products in a row, there is a high chance users do not see every product in the initial visit. Furthermore, in both cases, the user is forced to navigate out of the product list to a single product page- making the filters and sorting options in the Product List page redundant.</Col>
                    </Row>

                    <Row>
                        <Col style={{marginTop: "auto", marginBottom: "auto"}}><img alt='myntra' src={myntra} width="450px"></img></Col>
                        <Col style={{ width: "450px", padding: "30px" }}>Bad Experience
                            E-commerce platforms do not provide enough information for the user on the Product List page. Quick Views only show images and have little to no information about the product. The catalog of options is seldom curated at the start. Each product page does offer relevant options but the unlisted breadcrumb navigation through different windows can be difficult to trace back. Furthermore, switching through tabs takes the user out of the shopping zone. It can also affect the experience if there is an extended load time.</Col>
                    </Row>
                </Col>
           ...
           <img src={impcomp} alt='important components' width="850px" style={{paddingTop: "50px", paddingBottom: "50px"}}></img>
           ...
           <img src={wireframeux} alt='ux wireframe' width="850px" style={{paddingTop: "50px", paddingBottom: "50px"}}></img>
           ...
           <img src={redesignux} alt='redesigned ux' width="850px" style={{paddingTop: "50px", paddingBottom: "50px"}}></img>
           <p style={{fontSize: "18px", fontStyle: "italic"}}>You can see this low-fidelity prototype embed to know more</p>

           <iframe width="850" height="700" title='case study' src="https://xd.adobe.com/embed/a8b49c8f-a374-4cf9-b563-462258f0d3b8-fde7/" frameborder="0" allowfullscreen></iframe>
            </div>
            </div>
